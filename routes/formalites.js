...
// Déplacée dans web/ : Next ne sait pas charger un fichier hors de son projet.
const { generateAnnonceText } = require("../web/src/infrastructure/documents/annonce.cjs");
